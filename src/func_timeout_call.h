#ifndef __func_timeout_call_H_
#define __func_timeout_call_H_

/**
 *
 * the source form : https://github.com/bigwhite/experiments/tree/master/invoke_func_with_timeout_examples
 *
 */
